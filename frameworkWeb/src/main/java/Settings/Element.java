...
public class Element {
    ...
    public WebElement getWebElement(By by) {
        if (webElement == null){
           return Settings.Driver.getDriver().findElement(by);
        }
    ...
    public List<WebElement> getElements(){
        return Settings.Driver.getDriver().findElements(byMap.get(by));
    }
    ...
    public Element waitVisibleElement(){
        element = Settings.Driver.waitVisibleElement(byMap.get(by));
        return this;
    }

    public void waitInvisibleElement(){
        Settings.Driver.waitInvisibilityElement(byMap.get(by));
    }

    public Element waitClickableElement(){
        element = Settings.Driver.waitIsClickable(byMap.get(by));
        return this;
    }

    public Element waitIsPresentAlert(){
        alert = Settings.Driver.waitIsPresentAlert();
        return this;
    }
}
